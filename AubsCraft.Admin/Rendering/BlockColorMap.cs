...
public static class BlockColorMap
{
    ...
    private static readonly Dictionary<string, (float R, float G, float B)> Colors = new()
    {
        ...
        ["minecraft:orange_wool"] = (0.85f, 0.50f, 0.10f),
        ["minecraft:magenta_wool"] = (0.70f, 0.25f, 0.65f),
        ["minecraft:light_blue_wool"] = (0.40f, 0.55f, 0.80f),
        ["minecraft:yellow_wool"] = (0.85f, 0.80f, 0.20f),
        ["minecraft:lime_wool"] = (0.45f, 0.70f, 0.15f),
        ["minecraft:pink_wool"] = (0.80f, 0.50f, 0.60f),
        ["minecraft:gray_wool"] = (0.30f, 0.30f, 0.30f),
        ["minecraft:light_gray_wool"] = (0.60f, 0.60f, 0.60f),
        ["minecraft:cyan_wool"] = (0.10f, 0.45f, 0.50f),
        ["minecraft:purple_wool"] = (0.45f, 0.18f, 0.60f),
        ["minecraft:blue_wool"] = (0.20f, 0.25f, 0.65f),
        ["minecraft:brown_wool"] = (0.40f, 0.25f, 0.12f),
        ...
        ["minecraft:orange_concrete"] = (0.88f, 0.52f, 0.05f),
        ["minecraft:magenta_concrete"] = (0.65f, 0.20f, 0.65f),
        ["minecraft:light_blue_concrete"] = (0.35f, 0.55f, 0.82f),
        ["minecraft:yellow_concrete"] = (0.90f, 0.82f, 0.15f),
        ["minecraft:lime_concrete"] = (0.40f, 0.72f, 0.10f),
        ["minecraft:pink_concrete"] = (0.82f, 0.48f, 0.58f),
        ["minecraft:gray_concrete"] = (0.28f, 0.30f, 0.32f),
        ["minecraft:light_gray_concrete"] = (0.60f, 0.60f, 0.58f),
        ["minecraft:cyan_concrete"] = (0.08f, 0.42f, 0.48f),
        ["minecraft:purple_concrete"] = (0.42f, 0.15f, 0.58f),
        ["minecraft:blue_concrete"] = (0.15f, 0.18f, 0.60f),
        ["minecraft:brown_concrete"] = (0.38f, 0.22f, 0.10f),
        ["minecraft:green_concrete"] = (0.28f, 0.45f, 0.12f),
        ["minecraft:red_concrete"] = (0.58f, 0.12f, 0.10f),
        ["minecraft:black_concrete"] = (0.05f, 0.05f, 0.08f),
